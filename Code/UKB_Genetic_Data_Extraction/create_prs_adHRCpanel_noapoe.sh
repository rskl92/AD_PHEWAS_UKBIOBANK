...
plink \
--bgen ${SNP_DIR}/instruments_HRC_noapoe.bgen \
--sample ${UKBBDIR_HRC}/sample-stats/data.chr01.sample \
--score ${DISCOVERY_SAMPLE}/metaanalysis_effects.txt no-mean-imputation  \
--remove ${EXCLUSION_DIR}/total_exclusions.txt \
--out ${SNP_DIR}/UKBB_AD_NOAPOE_PRS_IGpgcADSP_HRCpanel \
