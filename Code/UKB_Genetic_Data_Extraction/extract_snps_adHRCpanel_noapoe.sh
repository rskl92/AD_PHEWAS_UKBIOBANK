...
export DATADIR="${HOME}/ukb_ad_phewas/Data/SNPs_AD_in_UKB"
...
for chrom in {1..22}; do
  ...
  bgenix -g $inbgen -i $inbgenidx -incl-rsids $DISCOVERY_SAMPLE/AD_rsids_noapoe.txt > $DATADIR/$temp_geno_prefix.$chrom_padd.bgen
done
cmd=""
...
cat-bgen -g ${cmd} -og $DATADIR/instruments_HRC_noapoe.bgen
# Remove temp genos
rm $temp_geno_prefix*
